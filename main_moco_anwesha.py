...
import yaml
from moco.datasets import MyUnlabeledDataset
from timm.data.constants import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
from moco.datasets import CLIP_MEAN, CLIP_STD
...
# Custom Dataset Specific Params
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = MyUnlabeledDataset(dataset_root=args.dataset_root,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            checkpoint_path = os.path.join(args.output_dir, 'checkpoint_%04d.pth.tar' % epoch)
            save_checkpoint({
                'epoch': epoch + 1,
                'arch': args.arch,
